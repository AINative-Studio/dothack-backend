"""
ZeroPipeline API Custom Exceptions

Provides specific error types for different failure scenarios.
"""


class ZeroPipelineError(Exception):
    """Base exception for all ZeroPipeline API errors."""
...
class ZeroPipelineAuthError(ZeroPipelineError):
...
class ZeroPipelineNotFound(ZeroPipelineError):
...
class ZeroPipelineRateLimitError(ZeroPipelineError):
...
class ZeroPipelineTimeoutError(ZeroPipelineError):
